 ...
 *
 * 優先順序：
 *   1. DiffRhythm2（HF Space，免費開源，有歌聲，需 HF_TOKEN）
 *   2. ACE Music（acemusic.ai，5 秒超時，備援）
 *
 * 環境變數：
...
export function isSunoConfigured(): boolean {
  return !!(HF_TOKEN || ACE_MUSIC_API_KEY);
}
